...
class CreateCollectionForSavingRecipesUseCase @Inject constructor(
    private val recipeRepository: RecipeRepository,
    private val dispatcher: CoroutineDispatcher
) {

    suspend operator fun invoke(name: String): RecipeCollection {
        return withContext(dispatcher) {
            recipeRepository.createRecipeCollectionForSaving(name)
        }
    }
}
